...
※ 주의!!!
[표준웹 결제창]
테스트 결제시 : src="https://testpay.kcp.co.kr/plugin/payplus_web.jsp"
리얼   결제시 : src="https://pay.kcp.co.kr/plugin/payplus_web.jsp"     로 설정해 주시기 바랍니다.
-->
<script language="javascript" src="https://testpay.kcp.co.kr/plugin/payplus_web.jsp"></script>
...
<form name="order_info" method="post" action="pp_cli_hub.aspx" >
...
<!--
	...
	/* 가맹점에서 관리하는 고객 아이디 설정. (상품권 결제 시 필수)
