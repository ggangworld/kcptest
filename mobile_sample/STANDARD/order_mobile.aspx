...
<%
    ...
    String buyr_tel1       = Request.Form[ "buyr_tel1"      ]; // 주문자 전화번호   
...
<form name="order_info" method="post">
  ...
  <input type="hidden" name="site_cd"         value="T0000">                         <!-- 사이트 코드 -->
...
<form name="pay_form" method="post" action="pp_cli_hub.aspx">
